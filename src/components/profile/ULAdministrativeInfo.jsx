                    ...
                    <div className="content">
                        <div className="box-content-wrapper">
                            ...
                            <ul className='info-container'>
                                <li>
                                    <span>Наличие чистого убытка за 3 последних полных месяца (для ЮЛ, которые используют упрощенную систему налогообложения)</span>
                                    <span>{data?.lossInfo?.netLossForTheLast3Months}</span>
                                </li>
                                <li>
                                    <span>Наличие чистого убытка на последнюю квартальную дату</span>
                                    <span>{data?.lossInfo?.netLossAsOfTheLastQuarterlyDate}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
...
export default ULAdministrativeInfo;