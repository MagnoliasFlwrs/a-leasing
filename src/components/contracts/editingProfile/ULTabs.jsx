                ...
                profile ?
                    <Tabs variant='unstyled' width='100%' className='ul-edit-tabs'>
                        <TabList gap='24px' flexWrap='wrap' className='contract-tablist'>
                            <Tab {...tabStyle} className='tab'>{profile[0]?.position}</Tab>
                            <Tab {...tabStyle} className='tab'>{profile[1]?.position}</Tab>
                            {
                                profile.length === 3 ?
                                    <Tab {...tabStyle} className='tab'>{profile[2]?.position}</Tab>
                                    :
                        ...
                        <TabPanels style={{paddingTop: '24px'}}>
                            <TabPanel style={{padding: '0'}}>
                                <EditForm person={profile[0]}/>
                            </TabPanel>
                            <TabPanel style={{padding: '0'}}>
                                <EditForm person={profile[1]}/>
                            </TabPanel>
