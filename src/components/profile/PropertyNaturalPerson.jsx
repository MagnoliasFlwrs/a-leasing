...
const PropertyNaturalPerson = ({data}) => {
        ...
        <div className='private-info-block'>
                ...
                <div className="box" onClick={(event) => boxHandler(event)}>
                    <div className="content">
                        <div className="box-content-wrapper">
                            <p className="title">Движимое имущество</p>
                            <ul className='info-container'>
                                <li>
                                    <span>Автомобиль в собственности да/нет</span>
                                    <span>{data?.maritalStatusAndPropertyInfo?.property?.ownCar}</span>
                                </li>
                                <li>
                                    <span>Марка авто</span>
                                    <span>{data?.maritalStatusAndPropertyInfo?.property?.brand}</span>
                                </li>
                                <li>
                                    <span>Год авто</span>
                                    <span>{data?.maritalStatusAndPropertyInfo?.property?.year}</span>
                                </li>
            ...
            <div className="accordeon">
                <div className="box" onClick={(event) => boxHandler(event)}>
                    <div className="content">
                        <div className="box-content-wrapper">
                            <p className="title">Недвижимое имущество</p>
                            <ul className='info-container'>
                                <li>
                                    <span>Недвижимое имущество в собственности</span>
                                    <span>{data?.maritalStatusAndPropertyInfo?.property?.ownRealEstate}</span>
                                </li>
...
export default PropertyNaturalPerson;