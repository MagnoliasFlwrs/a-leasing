...
const ReviewCard = () => {
    ...
    const text = 'Огромное спасибо Лаппо Елене за профессионализм, за оперативность и легкость ' +
        ...
        ' спасибо Лаппо Елене за профессионализм, за оперативность и легкость в принятии решений и подготовке' +
        ' документации. Вежливая, приятная, образованная, по больше бы таких специалистов и мастеров своего дела.' +
        ' Премию выпишите дополнительную';
