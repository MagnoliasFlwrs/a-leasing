...
const GeneralInfoIndividualEntrepreneur = ({data}) => {
        ...
        <div className='private-info-block'>
                ...
                <div className="box" onClick={(event) => boxHandler(event)}>
                    <div className="content">
                        <div className="box-content-wrapper">
                            <p className="title">Паспортные данные</p>
                            <ul className='info-container'>
                                ...
                                <li>
                                    <span>Пол</span>
                                    <span>{data?.fullName?.gender === 'Ж' ? 'Женский' : 'Мужской'}</span>
                                </li>
                                <li>
                                    <span>Дата рождения</span>
                                    <span>{data?.birthDayAndPlace?.birthday}</span>
                                </li>
                                <li>
                                    <span>Гражданство</span>
                                    <span>{data?.citizenship?.citizenship}</span>
                                </li>
                                <li>
                                    <span>Место рождения</span>
                                    <span>{data?.birthDayAndPlace?.birthplace}</span>
                                </li>
                                <li>
                                    <span>Серия и номер паспорта</span>
                                    <span>{data?.identityDocument?.documentSeries} {data?.identityDocument?.documentNumber}</span>
                                </li>
                                <li>
                                    <span>Идентификационный номер</span>
                                    <span>{data?.identityDocument?.personalNumber}</span>
                                </li>
                                <li>
                                    <span>Кем выдан паспорт</span>
                                    <span>{data?.identityDocument?.issuedAuthority}</span>
                                </li>
                                <li>
                                    <span>Когда выдан паспорт</span>
                                    <span>{data?.identityDocument?.dateOfIssue}</span>
                                </li>
                                <li>
                                    <span>Срок действия паспорта</span>
                                    <span>{data?.identityDocument?.validityPeriod}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div className="box-content-wrapper">
                            ...
                            <ul className='info-container'>
                                <li>
                                    ...
                                    <span>{data?.placeOfResidence?.regAddressCountry} {data?.placeOfResidence?.regAddressRegion} {data?.placeOfResidence?.regAddressLocality} {data?.placeOfResidence?.regAddressStreet}</span>
                                </li>
                                <li>
                                    <span>Место жительства (полный адрес)</span>
                                    <span>{data?.placeOfResidence?.livingAddressCountry} {data?.placeOfResidence?.livingAddressRegion} {data?.placeOfResidence?.livingAddressLocality} {data?.placeOfResidence?.livingAddressStreet}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div className="accordeon">
                <div className="box" onClick={(event) => boxHandler(event)}>
                    <div className="content">
                        <div className="box-content-wrapper">
                            <p className="title">Сведения о госрегистрации</p>
                            <ul className='info-container'>
                                <li>
                                    <span>УНП</span>
                                    <span>{data?.stateRegistrationInfo?.unp}</span>
                                </li>
                                <li>
                                    <span>Регистрационный номер</span>
                                    <span>{data?.stateRegistrationInfo?.registrationNumber}</span>
                                </li>
                                <li>
                                    <span>Дата регистрации</span>
                                    <span>{data?.stateRegistrationInfo?.dateOfRegistration}</span>
                                </li>
                                <li>
                                    <span>
                                        Наименование регистрирующего органа</span>
                                    <span>{data?.stateRegistrationInfo?.registeringAuthorityName}</span>
                                </li>
                                <li>
                                    <span>Является ли данное лицо публичным должностным лицом</span>
                                    <span></span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="box-content-wrapper">
                            ...
                            <ul className='info-container'>
                                <li>
                                    ...
                                    <span>{data?.contacts?.phoneNumber}</span>
                                </li>
                                <li>
                                    <span>Email</span>
...
export default GeneralInfoIndividualEntrepreneur;